...
def normalize_document(pathname, filename):
    ...
    with open(path, 'r') as document:
        for line in document:
            ...
            print_coloured_bold("Stopwords result", "cyan")
...
def identify_topics(pathname, filename):
   ...
   #computing categories weights opt 1
    ...
    #computing categories weights opt 2
    ...
    for c in categories_weights_sorted_opt1:
        ...
        for w in supporting_words_c:
            total_w += words_decay_values[w]
            words_decay_values[w] /= 2
        categories_weights[c[0]] *= total_w / len(supporting_words_c)

    print_coloured_bold("\n########### CATEGORIES WEIGHTS OPT 2###########", "cyan")
...
#identify_topics('./Documents', '103188')
#identify_topics('./Documents', '49960')
#identify_topics('./Documents', '14147')
#identify_topics('./Documents', '51060')
#identify_topics('./Documents', '59554') #med
#identify_topics('./Documents', '104504') #baseball
#identify_topics('./Documents', 'Ferrari')
