...
def create_final_dataset(total_num_articles):
    ...
    if current_num_articles == total_num_articles:
        print_coloured_bold("Total number of articles reached", "cyan")
    print_coloured_bold("Duplicates: " + str(duplicates), "cyan")
    print_coloured_bold("Total number articles: " + str(total_num_articles - duplicates), "cyan")
